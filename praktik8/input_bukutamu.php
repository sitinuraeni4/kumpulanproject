<?php 
    if (isset($_POST['upload'])) {
        ...
        $ip2 = getenv("HTTP_X_FORWARDER_FOR");
        $ip = $ip1 . '-' . $ip2;
        ...
        <form action="<?php $PHP_SELF ?>" method="POST" name="uploadform" id="uploadform">
            <table width="90%" border="0" align="center" cellpadding="2" cellspacing="2" class="content">
                ...
                <tr>
                    ...
                    <td>:</td>
                    <td><input type="text" name="temail" type="text" id="temail" size="30" maxlength="30">
                    </td>
                </tr>
                <tr>
                    <td valign="top"><strong>Pesan <span class="style1">*</span></strong></td>
                    <td>:</td>
                    <td><textarea type="text" name="tkomentar" cols="50" rows="5" id="tkomentar"></textarea></td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                    <td><input type="submit" name="upload" class="box" id="uploadform" value=" Submit"></td>
                </tr>
                <tr>
